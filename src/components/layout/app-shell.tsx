...
export function AppShell() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <motion.div
        initial={false}
        animate={{ marginLeft: collapsed ? 84 : 252 }}
      ...
      >
        ...
        <main
          className={
            compact
              ? "mx-auto w-full max-w-[1600px] px-4 py-5 pb-28 sm:px-6 lg:px-7 lg:py-6"
              : "mx-auto w-full max-w-[1600px] px-4 py-6 pb-28 sm:px-6 lg:px-8 lg:py-8"
          }
        >
      ...
      <Button
        className="fixed bottom-6 right-6 z-30 hidden h-11 rounded-full px-5 shadow-float lg:flex"
